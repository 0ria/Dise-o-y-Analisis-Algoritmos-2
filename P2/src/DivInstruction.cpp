...
DivInstruction::DivInstruction(/* args */) {}

DivInstruction::~DivInstruction() {}

void DivInstruction::parse(std::string instructionText) {
...
void DivInstruction::execute(Context& ctx) {
  if (directType == 0)
...
void DivInstruction::disassemble() {
